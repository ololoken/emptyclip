...
const  int          GAME_PROGRESSION_ADDED_LEVEL         =  10;
const  float        GAME_PROGRESSION_STAT_MULTIPLIER     =  0.1f;
const  float        GAME_PROGRESSION_DAMAGE_RESIST       =  1.0f;
...
const  int          ITEM_GOLD_QUALITY                    =  100;
const  int          ITEM_GOLD_CHANCE                     =  3;
