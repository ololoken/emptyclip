...
class _Entity : public _Object {
	...
	public:
		...
		double GetTrueAverageDamage(int AttackType) const { return (MinDamage[AttackType] + MaxDamage[AttackType]) * 0.5 * (1.0 + (CritDamage[AttackType] * 0.01 - 1.0) * CritChance[AttackType] * 0.01); }
